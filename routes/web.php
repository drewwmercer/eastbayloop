...
Route::get('/taste/bars-breweries-distilaries', 'TasteController@showBars')->name('taste-bars-page');
Route::get('/taste/bars-breweries-distilaries/bar', 'TasteController@showBar')->name('taste-bar-page');
Route::get('/taste/bars-breweries-distilaries/book-your-tasting', 'TasteController@showBookTasting')->name('taste-book-tasting-page');
Route::get('/taste/bars-breweries-distilaries/winery-to-visit', 'TasteController@showWinery')->name('taste-winery-page');
Route::get('/taste/bars-breweries-distilaries/buy-wine', 'TasteController@showBuyWine')->name('taste-buy-wine-page');
Route::get('/taste/bars-breweries-distilaries/community-partner', 'TasteController@showPartner')->name('taste-c-partner-page');
Route::get('/taste/bars-breweries-distilaries/winery-events', 'TasteController@showWineryEvents')->name('taste-winery-events-page');
Route::get('/taste/bars-breweries-distilaries/wine-loop-contact', 'TasteController@showBarWineLoopContact')->name('taste-bar-w-l-contact-page');
