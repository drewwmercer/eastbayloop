...
Route::get('/taste/bars-breweries-distilleries/book-your-tasting', 'TasteController@showBookTasting')->name('taste-book-tasting-page');
Route::get('/taste/bars-breweries-distilleries/winery-to-visit', 'TasteController@showWinery')->name('taste-winery-page');
Route::get('/taste/bars-breweries-distilleries/buy-wine', 'TasteController@showBuyWine')->name('taste-buy-wine-page');
Route::get('/taste/bars-breweries-distilleries/community-partner', 'TasteController@showPartner')->name('taste-c-partner-page');
Route::get('/taste/bars-breweries-distilleries/winery-events', 'TasteController@showWineryEvents')->name('taste-winery-events-page');
Route::get('/taste/bars-breweries-distilleries/wine-loop-contact', 'TasteController@showBarWineLoopContact')->name('taste-bar-w-l-contact-page');
