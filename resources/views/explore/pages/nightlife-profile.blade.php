...
@section('content')
    <profile-page inline-template>
        <main>
            <slider :data="[{img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Nightlife Profile', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Nightlife Profile', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Nightlife Profile', class: 'explore-slider'}]">
            </slider>
