...
@section('content')
    <profile-page inline-template>
        <main>
            <slider :data="[{img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Client Profile', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Client Profile', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/profile.png') }}', text: 'Client Profile', class: 'explore-slider'}]">
            </slider>
