...
@section('content')
    <profile-page inline-template>
        <main class="adventure-profile-page">
            <slider :data="[{img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Wine Loop', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Wine Loop', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Wine Loop', class: 'explore-slider'}]">
            </slider>
