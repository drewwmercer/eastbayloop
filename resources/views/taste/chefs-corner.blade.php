...
@section('content')
    <taste-page inline-template>
        <main>
            <slider :data="[{img: '{{ asset('assets/img/sliders/taste.png') }}', text: 'CHEF`S CORNER', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/taste.png') }}', text: 'CHEF`S CORNER', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/taste.png') }}', text: 'CHEF`S CORNER', class: 'explore-slider'}]">
            </slider>

            <section class="explore-cards custom-section">
                <div class="row explore-header mb-3 m-0 mr-2">
                    <div class="col-md-4 pl-4">
                        <input class="chefs-search" type="text" placeholder="Search"/>
                        <i class="fa fa-search chefs-search-icon"></i>
                    </div>
