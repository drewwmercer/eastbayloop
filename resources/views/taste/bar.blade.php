...
@section('content')
    <taste-page inline-template>
        <main>
            <slider :data="[{img: '{{ asset('assets/img/sliders/bar.png') }}', text: 'Bars', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/bar.png') }}', text: 'Bars', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/bar.png') }}', text: 'Bars', class: 'explore-slider'}]">
            </slider>

            <section class="explore-cards">
                <div class="row explore-header mb-3">
                    <h2 class="display-inline col-md-8 font-myriad-regular">Bars:</h2>
                ...
                <div class="row">
                    @for($i = 1; $i < 13; $i++)
                        <div class="default-card col-md-4 mb-4">
                            <a href="{{ route('taste-bar-profile-page') }}">
