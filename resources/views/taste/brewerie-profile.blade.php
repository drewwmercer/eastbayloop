...
@section('content')
    <taste-page inline-template>
        <main class="adventure-profile-page">
            <slider :data="[{img: '{{ asset('assets/img/sliders/brewerie.png') }}', text: 'Brewery Name', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/brewerie.png') }}', text: 'Brewery Name', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/brewerie.png') }}', text: 'Brewery Name', class: 'explore-slider'}]">
            </slider>
            ...
            <section class="profile-page">
                <div class="row m-0">
                    <div class="header w-100">
                        <div>
                            <h2 class="title">Brewery Name</h2>
                        </div>
                        <div>
                    ...
                    <div class="col-md-12 p-0 text-side-card">
                        <div class="text-side-wrapper row m-0">
                            ...
                            <div class="content col-md-7 p-3">
                                <h2 class="card-title">FEATURED BREW</h2>
                                <p class="card-text">
