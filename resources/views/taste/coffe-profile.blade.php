...
@section('content')
    <profile-page inline-template>
        <main class="adventure-profile-page">
            <slider :data="[{img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Coffee Shops & Bakeries', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Coffee Shops & Bakeries', class: 'explore-slider'},
                            {img: '{{ asset('assets/img/sliders/adventure-profile.png') }}', text: 'Coffee Shops & Bakeries', class: 'explore-slider'}]">
            </slider>
