  ...
  <body>
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
        ...
        <div class="form">
            ...
            <form action="#" method="post">
                ...
                <button type="submit" class="btn btn-primary btn-lg login-btn">REGISTER</button>
            </form>
    ...
    <div class="social-login col-sm-6 col-sm-offset-3">
        ...
        <div class="btn-group btn-group-one">
            ...
            <a href="#" class="btn btn-primary btn-fb">Register with Facebook</a>
        </div>
        <div class="btn-group btn-group-two">
            <a href="#" class="btn btn-info btn-tw"><i class="fa fa-twitter"></i></a>
            <a href="#" class="btn btn-info btn-tw">Register with Twitter</a>
        </div>
        <p class="sign-up">Have an account ? <a href="{{ url('/login') }}">SIGN IN!</a></p>
    </div>
